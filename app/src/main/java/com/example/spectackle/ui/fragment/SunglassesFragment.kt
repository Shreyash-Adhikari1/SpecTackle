...
import com.example.spectackle.databinding.FragmentSunglassesBinding
...
class SunglassesFragment : Fragment() {

    private lateinit var binding: FragmentSunglassesBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSunglassesBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sunglassesRecycler.apply {
    ...
    private fun fetchSunglasses() {
        productRepository.getProductByCategory("Sunglasses") { products, success, message ->
            if (success && products != null) {
                productList.clear()
                productList.addAll(products)
                productAdapter.notifyDataSetChanged()
            } else {
                Toast.makeText(requireContext(), "Failed to load sunglasses", Toast.LENGTH_SHORT).show()
            }
        }
    }
