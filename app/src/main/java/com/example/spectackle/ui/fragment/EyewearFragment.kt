...
import com.example.spectackle.databinding.FragmentEyewearBinding
...
class EyewearFragment : Fragment() {

    lateinit var binding: FragmentEyewearBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEyewearBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun fetchEyewear() {
        productRepository.getProductByCategory("Eyewear") { products, success, message ->
